export const portfolioData = [
  {
    id: "parque-eolico-licenciamento",
    slug: "licenciamento-ambiental-parque-eolico",
    title: "Licenciamento Ambiental Completo para Complexo Eólico",
    category: "Licenciamento e Estudos de Impacto",
    clientSector: "Energia Renovável",
    location: "Planalto Sul, SC",
  ...
  },
  {
    ...
    slug: "resgate-arqueologico-lt",
    title: "Diagnóstico e Resgate Arqueológico em Linha de Transmissão",
    category: "Arqueologia Preventiva",
    clientSector: "Infraestrutura Elétrica",
    location: "Joinville a Araquari, SC",
  ...
  },
  {
    ...
    slug: "estudo-impacto-vizinhanca-loteamento",
    title: "Estudo de Impacto de Vizinhança (EIV) para Macro Loteamento",
    category: "Estudos Urbanísticos",
    clientSector: "Desenvolvimento Imobiliário",
    location: "Litoral Norte, SC",
  ...
  },
  {
    ...
    slug: "inventario-monitoramento-fauna-industria",
    title: "Inventário de Fauna em Área de Expansão Industrial",
    category: "Estudos de Fauna e Flora",
    clientSector: "Indústria de Manufatura",
  ...
  {
    id: "prad-mineradora",
    slug: "prad-recuperacao-area-degradada-mineracao",
    title: "Projeto de Recuperação de Área Degradada (PRAD)",
    category: "Recuperação Ambiental",
    clientSector: "Mineração de Inertes",
    location: "Vale do Itajaí, SC",
